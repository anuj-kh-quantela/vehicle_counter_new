...
# video_path = '/home/anuj/git/personal/gitlab/end-to-end-api/vehicle-counter/akashwani.avi'
# # roi = np.array([(532, 256), (953, 307), (849, 808), (52, 541)],dtype = np.float32)
# # minm_area = 13455

vo = VehicleCounter(video_path, 'hyderabad', 'Deputy-01')
vo.vehicle_counter(minm_area=None, roi=None, plot_intermediate=True, check_interval=10, 
